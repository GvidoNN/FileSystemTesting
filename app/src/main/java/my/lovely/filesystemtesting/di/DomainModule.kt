...
import my.lovely.filesystemtesting.domain.usecase.GetAllFilesUseCase
...
class DomainModule {
    ...
    @Provides
    fun provideGetAllFilesUseCase(filesRepository: FilesRepository): GetAllFilesUseCase {
        return GetAllFilesUseCase(filesRepository = filesRepository)
    }
